--------------------------------------------------------
--  Arquivo criado - Quinta-feira-Abril-22-2021   
--------------------------------------------------------
--------------------------------------------------------
...
/
--------------------------------------------------------
--  DDL for Sequence CODGROUPTREESEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODGROUPTREESEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CODHARVESTSEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODHARVESTSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CODHARVESTTREESEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODHARVESTTREESEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CODSPECIESSEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODSPECIESSEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CODTREE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODTREE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CODTREESEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CODTREESEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence TB_TREE_PK
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."TB_TREE_PK"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TB_HARVEST
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TB_HARVEST" 
   (	"CODHARVEST" NUMBER(*,0), 
	"INFORMATION" VARCHAR2(60 BYTE), 
	"HARVESTDATE" DATE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TB_HARVEST_HAS_TREE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TB_HARVEST_HAS_TREE" 
   (	"CODHARVESTTREE" NUMBER, 
	"CODTREE" NUMBER(*,0), 
	"CODHARVEST" NUMBER(*,0), 
	"WEIGHT" FLOAT(126)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TB_SPECIES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TB_SPECIES" 
   (	"CODSPECIES" NUMBER(*,0), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TB_TREE
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TB_TREE" 
   (	"CODTREE" NUMBER(*,0), 
	"DESCRIPTION" VARCHAR2(60 BYTE), 
	"AGE" NUMBER(*,0), 
	"SPECIES" NUMBER(*,0)
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.TB_HARVEST
SET DEFINE OFF;
REM INSERTING into SYSTEM.TB_HARVEST_HAS_TREE
SET DEFINE OFF;
REM INSERTING into SYSTEM.TB_SPECIES
SET DEFINE OFF;
REM INSERTING into SYSTEM.TB_TREE
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index TB_ESPECIES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TB_ESPECIES_PK" ON "SYSTEM"."TB_SPECIES" ("CODSPECIES") 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index TB_HAVERST_HAS_TREE_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TB_HAVERST_HAS_TREE_PK" ON "SYSTEM"."TB_HARVEST_HAS_TREE" ("CODHARVESTTREE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index TB_ARVORES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TB_ARVORES_PK" ON "SYSTEM"."TB_TREE" ("CODTREE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index TB_COLHEITA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."TB_COLHEITA_PK" ON "SYSTEM"."TB_HARVEST" ("CODHARVEST") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Trigger AI_HARVEST
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AI_HARVEST" 
   before insert on "SYSTEM"."TB_HARVEST" 
   for each row 
begin  
   if inserting then 
      if :NEW."CODHARVEST" is null then 
         select CODHARVESTSEQ.nextval into :NEW."CODHARVEST" from dual; 
      end if; 
   end if; 
end;
/
ALTER TRIGGER "SYSTEM"."AI_HARVEST" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AI_HARVEST_TREE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AI_HARVEST_TREE" 
   before insert on "SYSTEM"."TB_HARVEST_HAS_TREE" 
   for each row 
begin  
   if inserting then 
      if :NEW."CODHARVESTTREE" is null then 
         select CODHARVESTTREESEQ.nextval into :NEW."CODHARVESTTREE" from dual; 
      end if; 
   end if; 
end;
/
ALTER TRIGGER "SYSTEM"."AI_HARVEST_TREE" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AI_SPECIES
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AI_SPECIES" 
   before insert on "SYSTEM"."TB_SPECIES" 
   for each row 
begin  
   if inserting then 
      if :NEW."CODSPECIES" is null then 
         select CODSPECIESSEQ.nextval into :NEW."CODSPECIES" from dual; 
      end if; 
   end if; 
end;

/
ALTER TRIGGER "SYSTEM"."AI_SPECIES" ENABLE;
--------------------------------------------------------
--  DDL for Trigger AI_TREE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SYSTEM"."AI_TREE" 
   before insert on "SYSTEM"."TB_TREE" 
   for each row 
begin  
   if inserting then 
      if :NEW."CODTREE" is null then 
         select CODTREESEQ.nextval into :NEW."CODTREE" from dual; 
      end if; 
   end if; 
end;

/
ALTER TRIGGER "SYSTEM"."AI_TREE" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TB_TREE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TB_TREE" ADD CONSTRAINT "TB_TREE_PK" PRIMARY KEY ("CODTREE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TB_TREE" MODIFY ("SPECIES" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TB_TREE" MODIFY ("CODTREE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TB_HARVEST_HAS_TREE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TB_HARVEST_HAS_TREE" ADD CONSTRAINT "TB_HAVERST_HAS_TREE_PK" PRIMARY KEY ("CODHARVESTTREE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TB_HARVEST_HAS_TREE" MODIFY ("CODHARVESTTREE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table TB_SPECIES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TB_SPECIES" ADD CONSTRAINT "TB_ESPECIES_PK" PRIMARY KEY ("CODSPECIES")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TB_SPECIES" MODIFY ("CODSPECIES" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TB_HARVEST" ADD CONSTRAINT "TB_HARVEST_PK" PRIMARY KEY ("CODHARVEST")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TB_HARVEST" MODIFY ("CODHARVEST" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table TB_HARVEST_HAS_TREE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TB_HARVEST_HAS_TREE" ADD CONSTRAINT "TB_HAVERSTFK" FOREIGN KEY ("CODHARVEST")
	  REFERENCES "SYSTEM"."TB_HARVEST" ("CODHARVEST") ENABLE;
  ALTER TABLE "SYSTEM"."TB_HARVEST_HAS_TREE" ADD CONSTRAINT "TB_TREEFK2" FOREIGN KEY ("CODTREE")
	  REFERENCES "SYSTEM"."TB_TREE" ("CODTREE") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TB_TREE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TB_TREE" ADD CONSTRAINT "TB_SPECIESFK" FOREIGN KEY ("SPECIES")
	  REFERENCES "SYSTEM"."TB_SPECIES" ("CODSPECIES") ENABLE;
